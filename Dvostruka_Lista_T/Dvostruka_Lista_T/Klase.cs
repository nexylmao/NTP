...
{ 
    public class Element<T>
    {
        ...
        public Element(T newValue,Element<T> previousElement = null, Element<T> nextElement = null)
        {
            Value = newValue;
    ...
    public class List<T>
    {
        ...
        public void Add(T newValue)
        {
            ...
            if (First == null)
            {
                First = new Element<T>(newValue, null, First);
            }
            else
            {
                LastElement.Next = new Element<T>(newValue, LastElement, LastElement.Next);
            }
        }
        ...
        public bool Insert(T newValue, int Index)
        {
            ...
            {
                Indexing(Index).Next = new Element<T>(newValue, Indexing(Index), Indexing(Index).Next);
                return false;
            }
        }
